...
This document was converted from [this LaTeX
template](https://github.com/AudreyBeard/Datasheets-for-Datasets-Template)
for *Datasheets for Datasets*, which is an article outlining best
practices for dataset documentation by Gebru et al. [@gebru2021da]
...
::: mdframed
# COMPOSITION {#composition .unnumbered}
:::
...
unprocessed text or images) or features? In either case, please provide
a description.\
YOUR ANSWER HERE\
...
data directly observable (e.g., raw text, movie ratings), reported by
...
YOUR ANSWER HERE\
**What was the resource cost of collecting the data?** (e.g. what were
the required computational resources, and the associated financial
costs, and energy consumption - estimate the carbon footprint. See
Strubell *et al.*\@strubellEnergyPolicyConsiderations2019 for approaches
in this area.)\
YOUR ANSWER HERE\
...
how notice was provided, and provide a link or other access point to, or
...
::: mdframed
# PREPROCESSING / CLEANING / LABELING {#preprocessing-cleaning-labeling .unnumbered}
:::
...
uses)?** If so, please provide a link or other access point to the "raw"
data.\
YOUR ANSWER HERE\
...
API, GitHub)?** Does the dataset have a digital object identifier
(DOI)?\
YOUR ANSWER HERE\
...
(ToU)?** If so, please describe this license and/or ToU, and provide a
link or other access point to, or otherwise reproduce, any relevant
